...
*/
	...
	// const [widgetConfig, setWidgetConfig] = React.useState(JSON.parse(localStorage.getItem("userConfig")) || DEFAULT_CONFIG)

	const [widgetConfig, setWidgetConfig] = React.useState(()=> {
		const savedConfigString = localStorage.getItem("widgetConfig");
